...
** [ ] Better event handler loop as current implementation is hacky
- Create global dispatch for RPC calls
- Make it reusable and use in UIState and terminal app
* [ ] Terminal UI
** [ ] Simple styling
*** [ ] Color usage
...
**** [ ] Better error instructions when blocks overlap
