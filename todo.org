...
* [ ] Configuration
** [ ] Ensure that variables are resolved together and then updated.
** [ ] Add a way to cascade variables by setting variable value to other variable value, recursively
...
** [ ] Continue after stopping runner on input does not show correct prompt
