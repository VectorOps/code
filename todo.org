#+title: Code ToDo
* [ ] Runner
** [ ] When looping on the same node - we need to append message to existing history. Update protocol to return user input back to executor without creating a new executor instance and losing a lot of function call context.
...
** [ ] Investigate stopping and cancelation of existing runners
* [ ] Error handling
...
* [ ] Terminal UI
** [ ] Add logging
** [ ] Fix line breaks - if line is naturally too long, then moving caret to the beginning of the line does not work, we need to go one line up.
...
*** [ ] Limit context length and reject tool calls when over
