...
* [ ] Terminal UI
** [ ] Node transitions are printed out of order:
*** Running apply
**** Running test
Applied patch successfully.
Fully updated files:
**** src/vocode/runner/executors/fileread.py
** [ ] Fix await
--- Unhandled exception in event loop ---
Unclosed client session

/Users/serge/work/code/src/vocode/ui/terminal/helpers.py:32: RuntimeWarning: coroutine 'run_in_terminal.<locals>.run' was never awaited
...
*** [ ] Patch format
**** [ ] Fix error reporting when block can not be found
*** [ ] Unified Diff format
* [ ] Nodes
