...
*** [ ] If LLM did not return token count, show estimation but add (est) to the UI
...
** [ ] Maximum tool call rounds should be configurable per node
...
** [ ] Web client tool
** [ ] Search tool
*** [ ] Specify that search tool does not support any special syntax
** [ ] Shell tool
...
*** [ ] Does not work with formatter types
** [ ] Delayed action tool
