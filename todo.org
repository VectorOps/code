...
**** [ ] When multiple chunks match, but we can't match any of the chunks - return all possible lines
*** [ ] Fenced diff format
*** [ ] Unified Diff format
* [X] Settings
** [X] Settings loader
...
*** [ ] Add patch tool mode for V4A specifically. It double-escapes everything quoted.
